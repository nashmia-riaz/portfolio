...
var projects = {
  DistanceDash: {
    ...
    Tags: "UNITY,C#,ANDROID,UI DESIGN,PROGRAMMING,ART,Published",
    ...
    Description:
      ...
      "<div class=\"in-text-image\"><img src=\"../images/distance dash - multiplayer lobby.gif\"><p class='caption'>Preview of multiplayer lobby, player highlight and teleport system</p></div>"+
      ...
      "<div class=\"in-text-image\"><img src=\"../images/distance dash - chat.gif\"><p class='caption'>Custom chat with auto-updated dynamic values</p></div>"+
  ...
  BombsAway: {
    ...
    Description:
      ...
      "<div class=\"in-text-image\"><img src=\"../images/Bombs away - wireframing.png\"><p class='caption'>Initial UX design for the game</p></div>"+
      "<div class=\"in-text-image\"><img src=\"../images/Bombs away - mockups.png\"><p class='caption'>Inital UI design based on the UX</p></div>"+
      ...
      "<p>Play testing once our prototype was finished showed that players had trouble scrolling the grid while holding the litterbox. Additionally, it was also hard for them to keep track of the coordinates. So, markers were made to persistently stay on screen and attach to the corners of the grid when out of view. Players could now drag the litterbox to the edge of the grid in order to scroll as well.</p>"+
      "<div class=\"in-text-image\"><img src=\"../images/Bombs away - scoll and markers.gif\"><p class='caption'>UX improvements - scroll system and markers attach to the edges</p></div>"+
      ...
      "<div class=\"in-text-image\"><img src=\"../images/Bombs away - tutorial.gif\"><p class='caption'>Tutorial designed using mecanim animation states</p></div>"+
      "<p>One of the bugs we encountered here (seen in the gif above - only button should be lighter but it leaves a trail to the left) had to do with the stencil functionality in Unity's built in shaders. For the tutorial, we wanted to bring the user's attention to the litter box button bottom right. We used a black slightly transparent overlay with a circular cutout over the button's position. When this cutout would animate into place, it would leave a trail. Eventually with upgrading our target Android API, the bug disappeared on its own. Happy accident!</p>"+
  ...
  KnockoutNation: {
    ...
    Tags: "UNITY,C#,ANDROID,GOOGLE PLAY SERVICES,PROGRAMMING,Published",
    ...
    Description:
      ...
      "<div class=\"in-text-image\"><img src=\"../images/knockout nation - tutorial.gif\"><p class='caption'>Initial tutorial with playable prompt</p></div>"+
      ...
      "<div class=\"in-text-image\"><img src=\"../images/knockout-nation-courts.png\"><p class='caption'>Various assets purchasable in the game store</p></div>"+
  ...
  PressPlay: {
    ...
    Description:
      ...
      "<div class=\"in-text-image\"><img src='../images/press-play-pickup.gif'><p class='caption'>Pickup action and highlight system</p></div>"+
      ...
      "<div class=\"in-text-image\"><img src='../images/press-play-mirror.gif'><p class='caption'>Mirror system implemented using render texture</p></div>"+
      ...
      "<div class=\"in-text-image\"><img src='../images/press-play-warehouse-layout.png'><p class='caption'>Warehouse level design</p></div>"+
      ...
      "<div class=\"in-text-image\"><img src='../images/press-play-death.gif'><p class='caption'>Mannequin death animation</div>"+
      ...
      "<div class=\"in-text-image\"><img src='../images/press-play-woods.png'><p class='caption'>Woods level design with modelled tree trunks and terrain</p></div>"+
      ...
      "<div class=\"in-text-image\"><img src='../images/press-play-footprints.png'><p class='caption'>Footprint system implemented on Unity terrains using collisions</p></div>"+
  ...
  DockIt: {
    ...
    Tags: "UNITY,C#,ANDROID,FIREBASE,UI DESIGN,PROGRAMMING,ART,Solo",
    ...
    Tags: "UNITY,C#,ANDROID,UI DESIGN,PROGRAMMING,ART,Solo",
  ...
  "<div class=\"in-text-image\"><img src='../images/mrbonesy-spline.png'><p class='caption'>Catmull-Romm splines in Unreal Engine</p></div>"+
  ...
  "<div class=\"in-text-image\"><img src='../images/mrbonesy-camera-flip.gif'><p class='caption'>Bug where camera would flip on steep slopes</p></div>"+
  ...
  "<div class=\"in-text-image\"><img src='../images/mrbonesy-diagram.png'><p class='caption'>Algorithm design for obstacle avoidance</div>"+
  ...
  "<div class=\"in-text-image\"><img src='../images/mrbonesy-obstacle-avoidance.gif'><p class='caption'>Obstacle avoidance in action</div>"+
  ...
  "<div class=\"in-text-image\"><img src='../images/mrbonesy-blueprint.png'><p class='caption'>Blueprint design for dynamic planets</div>"+
  ...
  "<div class=\"in-text-image\"><img src='../images/mrbonesy-equation.png'><p class='caption'>UI Design for Quick Time Events</p></div>"+
  ...
  "<div class=\"in-text-image\"><img src='../images/mrbonesy-division.png'><p class='caption'>Bug within Unreal where special characters wouldn't show</p></div>"+
  ...
  "<div class=\"in-text-image\"><img src='../images/mrbonesy-skybox.png'><p class='caption'>Cubemap for custom skybox design</p></div>"+
  ...
  Catronaut: {
    ...
    Tags: "UNITY, C#, ANDROID, GOOGLE PLAY SERVICES,PROGRAMMING,Solo",
    ...
    Description:
      ...
      "<div class=\"in-text-image\"><img src=\"../images/catronaut-preview.gif\"><p class='caption'>Preview of the gameplay</p></div>"+
      ...
      "<div class=\"in-text-image\"><img src=\"../images/catronaut-obstacles.png\"><p class='caption'>2D asset design</p></div>"+
  ...
  SilentKnight: {
    ...
    Tags: "UNITY,C#,ANDROID,DEMO,PROGRAMMING,Solo",
    ...
    Description:
      ...
      "<div class=\"in-text-image\"><img src=\"../images/silent-knight-traps.png\"><p class='caption'>Trap designs for variation</p></div>"+
  ...
  DamageControl: {
    ...
    Tags: "UNITY,C#,WEBGL,PROGRAMMING,Solo",
    ...
    Description:
      ...
      "<div class=\"in-text-image\"><img src=\"../images/damagecontrol/damage-control-preview.gif\"><p class='caption'>Damage Control- Preview</p></div>"+
  ...
  StackItUp: {
    ...
    Tags: "UNITY,C#,PROGRAMMING,UI DESIGN,Solo",
    ...
    Description:
      ...
      "<div class=\"in-text-image\"><img src=\"../images/stack-it-up-screens.png\"><p class='caption'>UI design for different screens in game</p></div>"+
  ...
  Perdita: {
    ...
    Tags: "ML-AGENTS,REINFORCEMENT LEARNING,UNITY,C#,PROGRAMMING,Solo",
    ...
    Description:
      ...
      "<div class=\"in-text-image\" id=\"maze-generation\"><img src=\"../images/maze-generation.gif\"><p class='caption'>Hunt-and-Kill maze generation algorithm in action</p></div>"+
